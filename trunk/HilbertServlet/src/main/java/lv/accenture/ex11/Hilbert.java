...
public class Hilbert {
  ...
  /*  public String sampleSVG() {
	...
	public String hilbertSVG(int order, String colour, String title) {
		...
		*/
		...
		sb.append("<!ENTITY ns_svg 'http://www.w3.org/2000/svg'>\n");
		sb.append("<!ENTITY ns_xlink 'http://www.w3.org/1999/xlink'>\n");
		sb.append("]>\n");
		
		sb.append("<svg version='1.1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' width='10cm' height='10cm' viewBox='0 0 ");
		...
		sb.append("   style='stroke:" + colour + ";stroke-width:0.01;fill:none;'>\n");
